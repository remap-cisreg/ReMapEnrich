...
#' @description Gets the number of overlaps for the query and the shuffles for each category of the catalog.
#' 
...
#' @param chromSizes An object containing all the chromosome lengths for the species in consideration.
#' @param fractionQuery The fraction of coverage (query on catalog) a hit must exceed to be accounted.
#' @param fractionCatalog The fraction of coverage (catalog on query) a hit must exceed to be accounted.
...
#' 
#' @return A list containing the number of overlaps for the query and the mean number of overlaps for the shuffles.
ComputeEnrichment <- function(query, catalog, chromSizes, fractionQuery, fractionCatalog, shuffles,
