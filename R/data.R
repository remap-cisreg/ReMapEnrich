...
#' This enrichment has been made with SOX2 from chr22 as a query and all the remap catalogue of the chr22 as a catalogue.
#' 
...
#' catFile <- system.file("extdata", "ReMap_nrPeaks_public_chr22.bed", package = "roken")
