...
#' @param sigType="q" Allows to choose between Q-significance, P-significance or E-significance.
...
EnrichmentBarPlot <- function(enrich, 
    ...
    TextOutline(y = midPoints[sig >= xMax], x = rep(xMax - (xMax*0.01), length(labSig)), 
