...
#' @description Gets the value of genomic enrichment 
#' for each feature of a bed file.
#' 
...
#' "ReMap_nrPeaks_public_chr22_SOX2.bed", package = "roken")
#' catalogFile <- system.file("extdata", 
#' "ReMap_nrPeaks_public_chr22.bed", package = "roken")
...
BedEnrichment <- function(queryFile, catalogFile, 
    ...
    countsList <- ComputeEnrichment(queryFile, catalogFile, chromFile,
                                    fractionQuery, fractionCatalog, shuffles,
