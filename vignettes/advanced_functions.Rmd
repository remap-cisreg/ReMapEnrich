...
vignette: >
    %\VignetteIndexEntry{roken-advanced-functions}
...
But in general, the universe could be understood as **bold**the set of regions that could have been used as query.**bold**
...
It is possible to load the chromosomes sizes og hg19 in one function.
